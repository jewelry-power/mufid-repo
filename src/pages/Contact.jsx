  ...
  return (
    <>
      <div className="h-80 bg-gray-50 flex items-center">
        <section className="bg-cover bg-center py-32 w-full background-2">
                ...
                <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div className="flex items-start">
                    <div className="shrink-0">
                      <div className="p-4 bg-zinc-600 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                        <svg
                          aria-hidden="true"
                          focusable="false"
                          data-prefix="fas"
